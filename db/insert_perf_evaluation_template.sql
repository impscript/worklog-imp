...
| มิติการประเมิน (Dimension) | สัดส่วน (Weight) | คะแนนดิบ (Raw Score / 10) | คะแนนถ่วงน้ำหนัก (Weighted Score) | เหตุผลและหลักฐานประกอบการประเมิน |\\n| :--- | :---: | :---: | :---: | :--- |\\n| **1. Planning** ...
...
| มิติการประเมิน (Dimension) | สัดส่วน (Weight) | คะแนนดิบ (Raw Score / 10) | คะแนนถ่วงน้ำหนัก (Weighted Score) | เหตุผลและหลักฐานประกอบการประเมิน |
| :--- | :---: | :---: | :---: | :--- |
| **1. Planning** (การวางแผนงาน) | 20% | [คะแนน] | [คะแนน x 0.2] | [เหตุผลประกอบโดยละเอียดในภาษาไทย] |
| **2. Execution** (การทำตามเป้าหมาย) | 25% | [คะแนน] | [คะแนน x 0.25] | [เหตุผลประกอบพร้อมเปรียบเทียบ Target vs Actual ในภาษาไทย] |
| **3. Accountability** (บทบาทความรับผิดชอบ) | 20% | [คะแนน] | [คะแนน x 0.2] | [เหตุผลเชิงสังเกตและประเมินตามตำแหน่งในภาษาไทย] |
| **4. Reflection & Improvement** (การเรียนรู้) | 25% | [คะแนน] | [คะแนน x 0.25] | [ระบุหลักฐานจากประวัติงานเรื่อง Case Study, WI, Knowledge Document ในภาษาไทย] |
| **5. Work Logging Quality** (คุณภาพการบันทึก) | 10% | [คะแนน] | [คะแนน x 0.1] | [เหตุผลประเมินตามเกณฑ์ Consistency, Completeness, Clarity, Traceability ในภาษาไทย] |
