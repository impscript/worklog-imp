...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    highlights: [
      ...
      'แก้ไขข้อมูลโครงการในหน้า Gantt แล้ว**ไม่ต้องโหลดหน้าใหม่ทั้งตาราง** ทำงานต่อจากจุดเดิมที่ค้างอยู่ได้ทันที',
  ...
  },
  {
    ...
    date: '2026-09-17',
    highlights: [
      'ถ้าเคยสังเกตว่างานที่บันทึกไว้บางรายการหายไปจาก Google Calendar (ทั้งที่หน้าเว็บแจ้งว่าซิงค์สำเร็จแล้ว) ตอนนี้**แก้ต้นเหตุแล้ว**',
  ...
  },
  {
    ...
    highlights: [
      ...
      'แก้ปัญหาบันทึกงานแล้ว**ไม่ขึ้นบน Google Calendar**บางรายการ',
      'แก้ปัญหาปฏิทิน**โหลดข้อมูลใหม่บ่อยเกินไป**ตอนสลับหน้าต่าง',
      'แก้ปัญหาบอร์ดผู้นำ (Leaderboard) **แสดงชื่อไม่ครบ**เมื่อสลับดู Workspace อื่น',
    ],
  },
  {
    version: '1.0.0',
    date: '2026-09-01',
    highlights: [
      'เวอร์ชันเริ่มต้นของ**ระบบแจ้งอัปเดต**',
    ],
  },
];
