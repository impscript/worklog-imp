          ...
          <div className="space-y-8 animate-in fade-in slide-in-from-bottom-2 duration-300">
            ...
            <div className="flex border-b border-slate-700/50 mt-6 mb-8">
              ...
              <button
                ...
                className="px-6 py-3 text-xs font-bold border-b-2 border-transparent text-slate-400 hover:text-indigo-400 hover:bg-slate-800/20 transition-all duration-200 flex items-center gap-2"
              >
